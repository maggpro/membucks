...
function Rating() {
  // Получаем данные текущего игрока из контекста
  ...
  // Пример данных текущего игрока (если он не в топ-100)
  const currentPlayer = {
  ...
  // Проверяем, входит ли игрок в топ-100
  const isInTop100 = ratingData.some(player =>
  ...
  return (
    <div className="rating-page">
      <div className="rating-block">
        ...
        {/* Показываем позицию текущего игрока, если он не в топ-100 */}
        {!isInTop100 && (
